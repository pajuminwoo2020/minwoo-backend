...
class Category(models.Model):
    ...
    name = models.CharField(max_length=255, blank=False, help_text='카테고리명')
    board_type = models.CharField(max_length=20, choices=TYPE_BOARD, null=False, blank=False, help_text='카테고리를 추가할 게시판 이름')
