...
urlpatterns = [
    # BoardActivityMember
    path('board/settlement', views.CreateBoardActivityMemberView.as_view(), name='board_settlement_create'),
    path('board/settlement/<int:board_id>', views.BoardActivityMemberView.as_view(), name='board_settlement'),
    path('board/settlements', views.BoardActivityMembersView.as_view(), name='board_settlements'),
