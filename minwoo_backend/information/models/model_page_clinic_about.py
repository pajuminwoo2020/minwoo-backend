...
class ClinicAbout(models.Model) :
    ...
    counseling_image = ResizedImageField(blank=True, null=True, max_length=2048, verbose_name='상담 및 지원 이미지', help_text='이미지 크기(130 x 130)')
    ...
    education_image = ResizedImageField(blank=True, null=True, max_length=2048, verbose_name='교육활동 이미지', help_text='이미지 크기(130 x 130)')
    ...
    activity_image = ResizedImageField(blank=True, null=True, max_length=2048, verbose_name='반성폭력활동 이미지', help_text='이미지 크기(130 x 130)')
